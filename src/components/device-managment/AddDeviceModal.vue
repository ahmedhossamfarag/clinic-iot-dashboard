        ...
        >
          ...
          <div class="p-7 flex flex-col gap-3">
            ...
            <div class="flex items-start justify-between mb-7">
              <div>
                <h2 class="text-2xl font-bold text-white tracking-tight">Add Device</h2>
                <p class="text-sm text-white/40 mt-1">Add New Device for the AI monitoring suite</p>
              </div>
              <button
            ...
            <button
              ...
              :class="loading
                ? 'bg-[#1e2535] text-white/30 cursor-not-allowed'
                : 'bg-[#1e2535] hover:bg-[#252d42] text-white active:scale-[0.98]'"
              :disabled="loading"
              @click="handleSubmit"
            >
              <span v-if="!loading">Add Device</span>
...
const { loading, error, createDevice } = useDevices()
