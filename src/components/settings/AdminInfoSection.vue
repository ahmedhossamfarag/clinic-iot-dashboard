...
const emit = defineEmits<{
  (e: 'update:adminName', value: string): void
  (e: 'update:adminEmail', value: string): void
}>()
</script>

<template>
  <section>
    <h2 class="text-white font-bold text-lg mb-1">Admin Information</h2>
    <p class="text-gray-400 text-sm mb-4">Update the primary contact information for system management.</p>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div class="flex flex-col gap-1">
          ...
          <input
            type="text"
            :value="adminName"
            @input="emit('update:adminName', ($event.target as HTMLInputElement).value)"
